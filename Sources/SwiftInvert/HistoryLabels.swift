...
func historyLabel(from a: ExposureSettings, to b: ExposureSettings) -> String {
    ...
    add("Dye separation", a.dyeSeparation != b.dyeSeparation, num(b.dyeSeparation))
    ...
    add("Yellow hue", a.yellowHue != b.yellowHue, num(b.yellowHue, "%+.2f"))
    add("Yellow saturation", a.yellowSaturation != b.yellowSaturation, num(b.yellowSaturation))
    add("Green hue", a.greenHue != b.greenHue, num(b.greenHue, "%+.2f"))
    add("Green saturation", a.greenSaturation != b.greenSaturation, num(b.greenSaturation))
    add("Blue hue", a.blueHue != b.blueHue, num(b.blueHue, "%+.2f"))
    add("Blue saturation", a.blueSaturation != b.blueSaturation, num(b.blueSaturation))
    ...
    add("Red levels", a.levelsRed != b.levelsRed)
    add("Green levels", a.levelsGreen != b.levelsGreen)
    add("Blue levels", a.levelsBlue != b.levelsBlue)

...
@Suite struct HistoryLabelTests {
    ...
    static let mutations: [(field: String, mutate: (inout ExposureSettings) -> Void)] = [
        ...
        ("contrastMask", { $0.contrastMask = 0.35 }),
        ("maskSpacer", { $0.maskSpacer = 5.5 }),
        ...
        ("levelsRed", { $0.levelsRed = [SIMD2(0.2, 0.35)] }),
        ("levelsGreen", { $0.levelsGreen = [SIMD2(0.6, 0.5)] }),
        ("levelsBlue", { $0.levelsBlue = [SIMD2(0.4, 0.45)] }),
